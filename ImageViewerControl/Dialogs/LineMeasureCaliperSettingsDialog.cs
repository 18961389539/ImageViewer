...
{
    internal sealed class LineMeasureCaliperSettingsDialog : Window
    {
        private readonly CaliperMeasureRoi _model;
        private readonly Action<CaliperMeasureRoi>? _previewAction;
        ...
        public LineMeasureCaliperSettingsDialog(CaliperMeasureRoi model, Action<CaliperMeasureRoi>? previewAction)
        {
            ...
            Title = UiText.Get("LineMeasureCaliperDialogTitle");
            Width = 360;
            Height = 480;
            ...
            {
                Text = UiText.Get("LineMeasureCaliperDialogHeading"),
            ...
            AttachPreviewHandler(_regionLengthTextBox);
            ...
            panel.Children.Add(new TextBlock
            {
                Text = UiText.Get("LineMeasureCaliperDialogDescription"),
        ...
        public CaliperMeasureRoi? Result { get; private set; }

        private void OnOkClick(object? sender, RoutedEventArgs e)
        {
            if (!TryApplyInputs(out string errorMessage))
            {
                MessageBox.Show(this, errorMessage, UiText.Get("LineMeasureCaliperDialogTitle"), MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
        ...
        private void PreviewCurrentValues()
        {
            ...
            _previewAction?.Invoke((CaliperMeasureRoi)_model.Clone());
        }
